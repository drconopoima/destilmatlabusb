function [Hdep] = entalpia(self, T, P, Comp, fase)
% Hdep = EdECubica.entalpia(T, P, Comp, fase)
%
%Calcula la entalpía residual a temperatura T, presión P, del compuesto Comp
