...
%alfa_fun calcula el parámetro alfa de Soave-Redlich-Kwong
%opcional el input: handle_m (default SRKEdE.m_SRKEdE(w)) para el cálculo del
%factor m del factor alfa de la ecuación de SRK.
%
%Referencia:
%
